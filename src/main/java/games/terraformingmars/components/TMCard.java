...
//                                    placetile(City,onMars,any) / effect
    ...
    public TMAction[] getImmediateEffects() {
        return immediateEffects;
    }

    public TMTypes.Tag[] getTags() {
        return tags;
    }
    ...
    public HashSet<Requirement<TMGameState>> getRequirements() {
        return requirements;
    }

    public LinkedList<Discount> getDiscountEffects() {
        return discountEffects;
    }

    public Effect[] getPersistingEffects() {
        return persistingEffects;
    }
}
